...
class ACTAttention:
    ...
    def log_overlay(
        ...
        *,
        ...
        `gamma` (display contrast) and `colormap` (palette) are the display dials;
        both default to the faithful/unchanged rendering. The SigLIP-specific
        knobs don't apply here — ACT's map is CNN activation magnitude.
        """
